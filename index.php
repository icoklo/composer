...
$app->get('/home/', "Home:funkcija");
$app->get('/home/registracija', "Registracija:funkcija");
$app->get('/home/korisnici', "Korisnici:funkcija");

$app->run();

/* 
NAPOMENE: kad se napravi neki novi file onda treba pozvati naredbu composer update tako da on prikupi info o tom novom fajlu i da skuzi da 
